    ...
    <>
      <footer className="bg-gray-800 text-gray-300 px-6 lg:px-8 py-12">
        ...
        <div className="max-w-screen-xl mx-auto ">
          <div className="grid grid-cols-6 md:grid-cols-9  lg:grid-cols-96  divide-gray-700 divide-y-2 md:divide-x-2 md:divide-y-0 md:-mx-8">
        ...
        <div className="max-w-screen-xl mx-auto flex flex-col md:flex-row justify-between items-center space-y-4 mt-8 lg:mt-12 border-t-2 border-gray-700 pt-8">
          <nav className="flex flex-wrap justify-center space-x-6">
            <Link href="#" className="text-sm mb-2" color="inherit">
              Cookie settings
            </Link>
          </nav>
